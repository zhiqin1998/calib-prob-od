...
def main(exp, args, num_gpu):
    ...
    if args.train:
        logger.warning('evaluating on train set, check if this is intended')

    evaluator = exp.get_evaluator(args.batch_size, is_distributed, args.test, args.legacy, train=args.train)
